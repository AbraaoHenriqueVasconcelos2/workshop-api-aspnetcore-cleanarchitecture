...
namespace EventFeedbackAPI.Domain.Entities
{
    public   class Participant
    {
        ...
        public Participant(int id, string cpf, string name, string address, string city, string neighborhood)
        {
            DomainExceptionValidation.When(id < 1, "The event ID cannot be zero or less than zero.");
            this.Id = Id;
            validateDomain(cpf, name, address, city, neighborhood);

        }


        public Participant(string cpf, string name, string address, string city, string neighborhood)
        {
            validateDomain(cpf, name, address, city, neighborhood);
        }

        public void Update(int id, string cpf, string name, string address, string city, string neighborhood)
        {
